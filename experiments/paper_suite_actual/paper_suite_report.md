...
- Output directory: `experiments\paper_suite_actual`
- Device: `cpu`
...
- Lowest avg forgetting: `task_routing (-0.2188)`
...
- Best operator avg accuracy: `sinkhorn_topk (0.6250)`
- Lowest operator avg forgetting: `kl_topk (-0.0312)`
