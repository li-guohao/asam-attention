...
- Plot image: `controller_round12_dbpedia_taskwise_dual_transport_ablation_correlation_seed44_plots.png`
- Raw JSON: `controller_round12_dbpedia_taskwise_dual_transport_ablation_correlation_seed44.json`
...
- Final hyperparameters: `{'prototype_prior_strength': 1.4943379206423564, 'prototype_capacity_blend': 0.2790310289707938, 'prototype_relocation_strength': 0.8790865326188727, 'prototype_merge_threshold': 0.9, 'prototype_merge_usage_threshold': 0.1, 'prototype_top_k': 2, 'transport_weight': 0.05, 'task_transport_weights': [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]}`