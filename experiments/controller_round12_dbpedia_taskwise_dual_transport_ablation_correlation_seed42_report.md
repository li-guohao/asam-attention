...
- Plot image: `controller_round12_dbpedia_taskwise_dual_transport_ablation_correlation_seed42_plots.png`
- Raw JSON: `controller_round12_dbpedia_taskwise_dual_transport_ablation_correlation_seed42.json`
...
- Final hyperparameters: `{'prototype_prior_strength': 1.394087742703059, 'prototype_capacity_blend': 0.26883084579080185, 'prototype_relocation_strength': 0.8861723994309266, 'prototype_merge_threshold': 0.9, 'prototype_merge_usage_threshold': 0.1, 'prototype_top_k': 2, 'transport_weight': 0.05, 'task_transport_weights': [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]}`